...
public class SecurityController {
	...
	public ResponseEntity<?> checkVerification(@RequestParam String code) {
		...
		if (stored != null && stored.equals(code)) {
			...
			return ResponseEntity.status(HttpStatus.BAD_REQUEST)
					.body(Map.of("result", "fail", "message", "인증 실패, 일치하지 않습니다."));
		}
	}
	...
	@ResponseBody
	public Map<String, Object> findIdProcess(@RequestParam("nickName") String nickName,
	...
	@ResponseBody
	public Map<String, Object> sendFindIdCode(@RequestParam String nickName, @RequestParam String email,
			HttpSession session) {
		Map<String, Object> response = new HashMap<>();
		// 닉네임과 이메일이 일치하는지 확인
		Optional<String> userId = uService.findIdByNameAndEmail(nickName, email);
	...
	@ResponseBody
	public Map<String, Object> verifyFindIdCode(@RequestParam String code, HttpSession session) {
		Map<String, Object> response = new HashMap<>();
	...
	@ResponseBody
	public Map<String, Object> findPwdProcess(@RequestParam("userId") String userId,
			@RequestParam("email") String email, HttpSession session) {
		Map<String, Object> response = new HashMap<>();
	...
	@ResponseBody
	public Map<String, Object> sendFindPwdCode(@RequestParam String userId, @RequestParam String email,
			HttpSession session) {
		Map<String, Object> response = new HashMap<>();
		// 아이디와 이메일이 일치하는지 확인
		Optional<String> userPwd = uService.findPwdByIdAndEmail(userId, email);
	...
	@ResponseBody
	public Map<String, Object> verifyFindPwdCode(@RequestParam String code, HttpSession session) {
		Map<String, Object> response = new HashMap<>();
	...
	public String update(@Validated @ModelAttribute UserExt loginUser, BindingResult bindResult, Authentication auth,
