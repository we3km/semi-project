			...
			<div class="keywords">
				...
				<div class="seller-info">
					<div class="profile">
						...
						<div style="font-weight: bold;" onclick="location.href='${pageContext.request.contextPath}/user/mypageOthers?userNum=${board.boardCommon.userNum}'" style="cursor: pointer;">${writer} </div>
					</div>
					<c:choose>
