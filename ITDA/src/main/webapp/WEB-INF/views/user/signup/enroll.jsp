...
<body>
    <form id="enrollForm" action="${pageContext.request.contextPath}/user/signup/enroll" method="post" enctype="multipart/form-data">
        <div class="top">
            <h1>회원정보 입력</h1>
            <hr>
        </div>
        <div class="middle">
            ...
            <div class="right">
            	<!-- 아이디 -->
                <input type="text" id="id" name="userId" value="${user.userId}" required pattern="\w{4,12}">
                &nbsp;&nbsp;&nbsp;
				...
				<!-- 닉네임 -->
                <input type="text" id="nick-name" name="nickName" value="${user.nickName}" required pattern="^(([가-힣]{2,8})|([a-zA-Z]{4,16})|([가-힣a-zA-Z]{2,10}))$"><br>
                한글기준 2자~8자, 영문기준 4자~16자로 입력해주세요.<br><br>
				
				<!-- 비밀번호 -->
                <input type="password" id="pwd" name="userPwd" value="${user.userPwd}" required><br>
                영문,숫자 혼합하여 8자~15자로 입력해주세요<br><br>
                <input type="password" id="pwd-check" name="userPwdCheck" required pattern="^(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z0-9]{8,15}$">
                <span id="pwd-status"></span><br>
                영문,숫자 혼합하여 8자~15자로 입력해주세요<br><br>
				...
				<!-- 폰번호 -->
                <input type="text" id="phone" name="phone" value="${user.phone}" required autocomplete="tel" pattern="^010-\d{4}-\d{4}$"><br>
                ...
                <div class="address"><br>
                    <input type="text" id="address1" name="address-line1" autocomplete="address-line1" required>&nbsp;&nbsp;&nbsp;
                    <input type="button" class="zip-btn" value="우편번호 검색" onclick="execDaumPostcode()">
                </div><br>
                <div class="address"><br>
                    <input type="text" id="address2" name="address-line2" autocomplete="address-line2" required>
                </div><br>
                &nbsp;
				...
				<input type="file" id="imageFile" name="profileImage" accept="image/*" style="display: none;" onchange="previewImage(event)"/>
				<br><br>

				<!-- 정보 유효 기간 -->
                <div class="exp-date">
                    회원정보 유효기간을 선택해주세요<br>
                    <input type="radio" id="1" name="validPeriod" value="1년"> 1년 
                    <input type="radio" id="2" name="validPeriod" value="2년"> 2년 
                    <input type="radio" id="3" name="validPeriod" value="3년"> 3년 
                    <input type="radio" id="end" name="validPeriod" value="회원탈퇴시까지"> 회원탈퇴 시 까지
                    <br><br>
                ...
                <input type="button" id="next" value="가입완료" onclick="submitSuccess()">
