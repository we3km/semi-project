  ...
  <!-- 고객센터 작성 시작 -->
    <div class="center-wrapper">
      ...
      <div class="header-mq">
        ...
        <button class="inquiry-btn" type="button">1:1 문의</button>
      </div>
      ...
      <div class="faq-list">
        <div class="qa-item">
          <button class="question" type="button">Q1. 비매너 채팅을 하는 유저가 있어요!</button>
        ...
        <div class="qa-item">
          <button class="question" type="button">Q2. 상대방이 물건을 보내주지 않았어요.</button>
          <div class="answer" style="display: none;">
        ...
        <div class="qa-item">
          <button class="question" type="button">Q3. 경매에 낙찰됐는데 구매하기가 싫어요 ㅠㅠ</button>
          <div class="answer" style="display: none;">
